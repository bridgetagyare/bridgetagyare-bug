...
# _13b_config = HybridConfig(emb_dim=5120, nheads=40, nlayers=40)
# # todo: add 35B config

# _70b_config = HybridConfig(
#     emb_dim=8192,
#     multiple_of=4096,
#     nheads=64,
#     kvheads=8,
...
# models.register_model(_architecture_name, "13b", hybrid_mamba_factory_factory(_13b_config))
# models.register_model(_architecture_name, "70b", hybrid_mamba_factory_factory(_70b_config))
